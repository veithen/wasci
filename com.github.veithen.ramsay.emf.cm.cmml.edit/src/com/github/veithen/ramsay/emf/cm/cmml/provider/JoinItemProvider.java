...
/**
 * This is the item provider adapter for a {@link com.github.veithen.ramsay.emf.cm.cmml.Join} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JoinItemProvider
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Join_referenceName_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Join_referenceName_feature", "_UI_Join_type"),
                 CMMLPackage.Literals.JOIN__REFERENCE_NAME,
                 true,
                 false,
                 false,
    ...
    protected void addOppositeReferenceNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Join_oppositeReferenceName_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Join_oppositeReferenceName_feature", "_UI_Join_type"),
                 CMMLPackage.Literals.JOIN__OPPOSITE_REFERENCE_NAME,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(CMMLPackage.Literals.JOIN__FROM);
            childrenFeatures.add(CMMLPackage.Literals.JOIN__TO);
            childrenFeatures.add(CMMLPackage.Literals.JOIN__KEY_MAPPINGS);
        }
    ...
    public String getText(Object object) {
        String label = ((Join)object).getReferenceName();
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (CMMLPackage.Literals.JOIN__FROM,
                 CMMLFactory.eINSTANCE.createType()));

        newChildDescriptors.add
            (createChildParameter
                (CMMLPackage.Literals.JOIN__TO,
                 CMMLFactory.eINSTANCE.createType()));

        newChildDescriptors.add
            (createChildParameter
                (CMMLPackage.Literals.JOIN__KEY_MAPPINGS,
                 CMMLFactory.eINSTANCE.createKeyMapping()));
    }
    ...
    public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
        ...
        boolean qualify =
            childFeature == CMMLPackage.Literals.JOIN__FROM ||
            childFeature == CMMLPackage.Literals.JOIN__TO;
